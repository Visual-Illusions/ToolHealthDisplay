 ...
 */
public final class StatusTranslator extends MessageTranslator {

    public StatusTranslator(VisualIllusionsPlugin plugin, String defaultLocale, boolean updateLang) {
